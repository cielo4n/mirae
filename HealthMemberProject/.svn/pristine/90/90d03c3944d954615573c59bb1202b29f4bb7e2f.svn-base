...
public class MainScreen extends JFrame implements ActionListener {
	...
	public MainScreen() {
		...
		setLocationRelativeTo(null); //창을 가운데로 위치
		...
		loginTextField.setFont(new Font("맑은 고딕", Font.BOLD, 15));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		// 로그인 누르면 관리자에체크됐는지 헬스장에 체크됐는지 확인후 로그인해주는이벤트
		else if (obj == bt) {
			String id = loginTextField.getText();
			String pw = new String(passwordField.getPassword());

			if (id.equals("") || pw.equals("")) { // 공란일 경우
